...
class Adaline():
    # Constructor
    def __init__(self, d, xi, n_muestras, wi, fac_ap,epochs, umbral, w_ajustado, Max_ciclo, Max_num_err):
        self.d = d
        self.xi = xi
    ...
    def Entrenamiento(self):
        ...
        while(self.epochs < Max_ciclo and Err_count < Max_num_err):
            ...
            for i in range(self.n_muestras):
                ...
                self.umbral = self.umbral = (self.fac_ap * Err_cuad_act)
            ...
            print(self.epochs,self.umbral, Err_act)
            self.epochs += 1
            #print(E_red)
...
if __name__ == "__main__":
    ...
    Max_num_err = 4 # Número máximo de veces que se repite un error
    w_ajustado = [] # Array de pesos de Adaline
    
    red = Adaline(des_ent, xi_ent, n_muestras_ent, wi, fac_ap,epochs, umbral, w_ajustado, Max_ciclo, Max_num_err) # Inicializar la red Adaline
